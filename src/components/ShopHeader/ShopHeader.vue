<!--<template>
  <div class="shop-header">
    ...
    &lt;!&ndash;  v-if : 如果为false,内部的模板会不断解析 &#45;&#45;  解决出事显示异常的问题&ndash;&gt;
    &lt;!&ndash;  初始显示出问题？3层表达式&ndash;&gt;
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupports = true">
      <div class="discounts-left">
        <div class="activity" :class="supportClass[info.support[0].type]">
          <span class="content-tag">
            <span class="mini-tag">{{info.support[0].name}}</span>
          </span>
          <span class="activity-content">{{info.support[0].content}}</span>
        </div>
      </div>
      <div class="discounts-right">
        {{info.support.length}}个优惠
      </div>
    </div>
    ...
    <div class="activity-sheet" v-show="isShowSupports">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item activity-green" v-for="(support,index) in info.support"
